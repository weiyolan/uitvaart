...
export const serviceType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "contactForm",
      description:
        "Het volledig-scherm aanvraagformulier voor deze dienst. Leeg laten = de ingebouwde standaardvragen worden gebruikt.",
      fieldsets: [
        { name: "intro", title: "Inleiding", options: { collapsible: true, collapsed: false } },
        { name: "chrome", title: "Knoppen & meldingen", options: { collapsible: true, collapsed: true } },
      ],
      fields: [
        ...
        defineField({
          ...
          title: "Vragen",
          description:
            "Eén vraag per scherm. Voeg een verplichte e-mailvraag toe zodat de bezoeker een bevestiging ontvangt.",
          type: "array",
          of: [defineArrayMember({ type: "formStep" })],
        }),
        defineField({ name: "submitLabel", title: "Verzendknop", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({ name: "submittingLabel", title: "Verzendknop (bezig)", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({ name: "backLabel", title: "Knop: vorige", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({ name: "nextLabel", title: "Knop: volgende", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({ name: "reviewLabel", title: "Knop: nakijken", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({ name: "reviewTitle", title: "Nakijken: titel", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({
          name: "progressLabel",
          title: "Voortgang",
          description: "Gebruik {current} en {total}, b.v. “Vraag {current} van {total}”.",
          type: "internationalizedArrayString",
          fieldset: "chrome",
        }),
        defineField({ name: "successTitle", title: "Succes: titel", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({ name: "successBody", title: "Succes: tekst", type: "internationalizedArrayText", fieldset: "chrome" }),
        defineField({ name: "errorBody", title: "Fout: tekst", type: "internationalizedArrayText", fieldset: "chrome" }),
        defineField({ name: "consentLabel", title: "Toestemming (privacy)", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({ name: "requiredError", title: "Foutmelding: verplicht veld", type: "internationalizedArrayString", fieldset: "chrome" }),
        defineField({ name: "emailError", title: "Foutmelding: e-mail", type: "internationalizedArrayString", fieldset: "chrome" }),
      ],
    }),
